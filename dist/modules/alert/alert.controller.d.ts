...
export declare class AlertController {
    ...
    create(createAlertDto: CreateAlertDto, req: any): Promise<import("./alert.entity").Alert>;
    ...
    findByUserId(req: any): Promise<import("./alert.entity").Alert[]>;
    findOne(id: string): Promise<import("./alert.entity").Alert>;
    update(id: string, updateAlertDto: UpdateAlertDto, req: any): Promise<import("./alert.entity").Alert>;
