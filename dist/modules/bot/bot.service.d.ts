...
export declare class BotService implements OnModuleInit {
    ...
    private priceMonitoringService;
    private userService;
    private bot;
    constructor(registrationTokenService: RegistrationTokenService, alertService: AlertService, monitoringService: MonitoringService, priceMonitoringService: PriceMonitoringService, userService: UserService);
    onModuleInit(): void;
