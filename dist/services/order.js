...
exports.createOrder = function (side, quantity, price, SYMBOL) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, axios_1["default"].post((config_1["default"] ? .BINANCE_API_URL : ) + "/api/v3/order", null, {
                        headers: {
                            "X-MBX-APIKEY": config_1["default"] ? .API_KEY : 
                        },
                        params: __assign({ signature: generateSignature(getQueryString(payload)) }, payload)
                    })];
            case 1:
                response = _a.sent();
