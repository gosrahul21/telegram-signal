    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    return [2 /*return*/, response.data.map(function (candle) { return ({
                            openTime: candle[0],
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error("Error fetching Binance candle data:", error_1);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_2 = _a.sent();
                    console.error("Error fetching Binance ticker price:", error_2);
                    return [2 /*return*/, null];
                case 3: return [2 /*return*/];
            }
        });
